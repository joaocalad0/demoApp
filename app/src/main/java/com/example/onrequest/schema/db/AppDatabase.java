            ...
            INSTANCE = Room.databaseBuilder(context.getApplicationContext(),
                    ...
                    addCallback(new Callback() {
                        ...
                        public void onCreate(@NonNull SupportSQLiteDatabase db) {
                            ...
                            db.execSQL("INSERT INTO menuitem VALUES(7, 'Big Mac', 5.6, '@drawable/big_mac', 'FOOD', 'A sanduíche dupla mais cobiçada no mundo inteiro. Feita com dois suculentos hambúrgueres 100% carne de vaca, queijo fundido, pepino, cebola, alface e um molho irresistível. Uma combinação única. ',2)");
